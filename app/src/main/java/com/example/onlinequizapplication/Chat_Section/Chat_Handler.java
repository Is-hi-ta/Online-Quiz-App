package com.example.onlinequizapplication.Chat_Section;
...
public class Chat_Handler extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        database1 = FirebaseDatabase.getInstance("https://online-quiz-application-596ee-default-rtdb.firebaseio.com/").getReference();
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://online-quiz-application-596ee-default-rtdb.firebaseio.com/");
